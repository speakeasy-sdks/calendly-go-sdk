...
func (s *organizations) DeleteMemberships(ctx context.Context, request operations.DeleteOrganizationsUUIDMembershipsRequest) (*operations.DeleteOrganizationsUUIDMembershipsResponse, error) {
	baseURL := s.serverURL
...
func (s *organizations) GetInvitations(ctx context.Context, request operations.GetOrganizationsOrgUUIDInvitationsUUIDRequest) (*operations.GetOrganizationsOrgUUIDInvitationsUUIDResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/organizations/{org_uuid}/invitations/{uuid}", request, nil)
...
func (s *organizations) InviteUser(ctx context.Context, request operations.PostOrganizationsUUIDInvitationsRequest) (*operations.PostOrganizationsUUIDInvitationsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/organizations/{uuid}/invitations", request, nil)
...
func (s *organizations) ListInvitations(ctx context.Context, request operations.GetOrganizationsUUIDInvitationsRequest) (*operations.GetOrganizationsUUIDInvitationsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/organizations/{uuid}/invitations", request, nil)
...
func (s *organizations) ListMemberships(ctx context.Context, request operations.ListOrganizationMembershipsRequest) (*operations.ListOrganizationMembershipsResponse, error) {
	baseURL := s.serverURL
	...
	res := &operations.ListOrganizationMembershipsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.ListOrganizationMemberships200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 500:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.ListOrganizationMembershipsErrorResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *organizations) RevokeInvite(ctx context.Context, request operations.RevokeUsersOrganizationInvitationRequest) (*operations.RevokeUsersOrganizationInvitationResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/organizations/{org_uuid}/invitations/{uuid}", request, nil)
